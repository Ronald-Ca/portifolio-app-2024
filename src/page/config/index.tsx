...
import ConfigCurriculum from "./config-curriculum";

export default function Config() {
	const [activeComponent, setActiveComponent] = useState<'home' | 'about' | 'skills' | 'projects' | 'social-media' | 'stack' | 'experience' | 'curriculum'>('home');
